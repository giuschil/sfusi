...
if(document.getElementById("map") !== null){
	...
	// ----------------------------------------------- //
	var locations = [
		[ locationData('valencia-picanya.html','images/partners/logo-boxingunitres.png',"Boxing Unitres",'Av. Castelló, 7. 46210 Picanya, Valencia', '3.5', '12'), 39.437182, -0.429467, 1, '<i class="im im-icon-Box"></i>'],
		[ locationData('valencia-malvarrosa.html','images/partners/logo_btvlc_beachtennisvalencia.png','Beach Tennis Valencia','Playa Malvarrosa', '5.0', '23'), 39.469787, -0.323811,          2, '<i class="im im-icon-Tennis"></i>'],
		[ locationData('valencia-universidades.html','images/centers/street_workout_valencia.png','Street Workuot','Carrer de l Enginyer Fausto Elio, 78D, 46011 València, Valencia', '2.0', '17'), 39.483452, -0.331451,         3, '<i class="im im-icon-Bodybuilding"></i>' ],
